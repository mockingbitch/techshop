...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['add'])){
    $addproduct = $product->insert_product($_POST,$_FILES);
}
?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 align="center" style="text-shadow: 1px 1px 5px grey;">Thêm danh sản phẩm</h1>
                            ...
                            <form id="quickForm" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="productDes" class="form-control" cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Mô tả chi tiết</label>
                                        <textarea id="editor1"  name="content" class="form-control" cols="30" rows="10"></textarea>
                                    </div>
