        ...
        <div class="row">
            ...
            <div class="col-md-5 col-md-push-2">
                <div id="product-main-img">
                    <div class="product-preview">
                        <img src="admin/uploads/products/<?php echo $result_pr['img']; ?>" alt="">
                    </div>
            ...
            <div class="col-md-5">
                <div class="product-details">
                    <h2 class="product-name"><?php echo $result_pr['productName']; ?></h2>
                    <div>
                    ...
                    <div>
                        <h3 class="product-price"><?php echo number_format($result_pr['productPrice'],0,',','.');?> Đ</h3>
                        <span class="product-available">In Stock</span>
                    </div>
                    <p><?php echo $result_pr['productDescription']; ?></p>
